...
export class AuthController {
  ...
  async refresh(req: Request, res: Response): Promise<Response> {
    const result = await authService.refresh(req.body as RefreshInput, buildContext(req));
    return sendSuccess(req, res, result);
  }

  async logout(req: Request, res: Response): Promise<Response> {
    const result = await authService.logout(req.body as LogoutInput, req.user!, buildContext(req));
    return sendSuccess(req, res, result);
  }

  async register(req: Request, res: Response): Promise<Response> {
    const result = await authService.register(req.body as RegisterInput, buildContext(req));
    return sendSuccess(req, res, result);
  }
